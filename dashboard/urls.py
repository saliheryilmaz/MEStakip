...
urlpatterns = [
    ...
    path('filo/', views.filo_yonetimi, name='filo_yonetimi'),
    path('filo/islem-gorenler/', views.filo_islem_gorenler, name='filo_islem_gorenler'),
    path('filo/ekle/', views.filo_ekle, name='filo_ekle'),
    path('filo/export-excel/', views.filo_export_excel, name='filo_export_excel'),
    path('filo/excel-yukle/', views.filo_excel_yukle, name='filo_excel_yukle'),
    path('filo/<int:arac_id>/duzenle/', views.filo_duzenle, name='filo_duzenle'),
    path('filo/<int:arac_id>/sil/', views.filo_sil, name='filo_sil'),
    path('filo/<int:arac_id>/durum/', views.filo_durum_degistir, name='filo_durum_degistir'),
